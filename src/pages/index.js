  ...
  render() {
    return (
      <Layout>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-5 text-center">
                ...
                <p className="text-white-50 mb-4">
                  ...
                  Have a look around at what I can do with my free time. If you
                  like what you see, imagine what I can do when I'm on the
                  clock!
                </p>
                <a
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <h3 className="h4 mb-2">Web Design</h3>
                  <p className="text-white mb-0">
        ...
        <section id="portfolio" className="page-section bg-primary">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-5 text-center">
                <h2 className="text-white mt-0">
        ...
        >
          <section className="page-section bg-primary" id="top">
            <div className="col-lg-10">
              ...
              <p className="text-white-50 mb-4">
                ...
                <ul>
                  ...
                  <li>
                    Technologies: VisualStudio 2015, Eclipse, Git, dependency
              ...
              <p className="text-white-50 mb-4">
                <ul>
                  <u>Academic Achievments:</u>
                  <br />
                  President's Honor List (Fall 2012 and Fall 2019)
                  <br />
                  Student Recognition Award for Outstanding Contribution for
                  Sigma Chi Eta
                  <br />
              ...
              <p className="text-white-50 mb-4">
                Woz-U, Scottsdale, AZ –– 04/2018-06/2018
                <br />
                Front-end Frameworks with ReactJS. Acquired skills to program
                using JavaScript, and build database-driven web applications
                using MongoDB, JavaScript, and the ReactJS library.
              </p>
              <p className="text-white-50 mb-4">
                <b>EXPERIENCE</b>
                <br />
                ...
                <ul>
                  <li>
                    Assist students with math problems ranging from MAT082 to
                    MAAT267 (remedial algebra through differential equations)
                  </li>
                  <li>
                    Worked one-on-one with students in MAT108 courses to find
                    solutions to achieve academic success in their math classes
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    including languages such as C, C++, Java, Prolog, and LISP
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    professor, host directed tutoring sessions for approximately
                    18 students
                  </li>
                  <li>
                    Worked one-on-one with students for fundamental programming
                    concepts for JAVA, computer system concepts, and fundamental
            ...
            <div className="row justify-content-center">
              <a
                className="btn btn-light btn-xl js-scroll-trigger"
                href="#"
                onClick={(this.state.modalShow = false)}
              >
                Looks impressive!
              </a>
            </div>
